    /**
    * This is my first properly documented piece java code. * When the javadoc tool is run over this code, it will
    * create an HTML maintenance * @author Laurissa Tokarchuk * @version 1.0
    * @author Paula
    * @version 1.1
    manual.
    */
public class CountDownExample {
    /**
    * This method counts down from a specified number * to zero. It will print its progress to the
    * command line.
